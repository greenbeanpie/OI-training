	...
	namespace Main
{
	...
	int color[300005], dep[300005], fa[300005];
	vector<int> e[300005];
	void lca(int u, int v, cc_hash_table<int, int> &ht)
	{
		if (dep[u] < dep[v])
		{
			swap(u, v);
